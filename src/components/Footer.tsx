...
const Footer = () => {
	return (
		<footer className="w-full mt-[30px] mb-[15px] text-slate-500 px-[20px] md:px-[60px] flex flex-row justify-between items-center">
			<div>
				...
				<h1 className="md:text-[16px] hidden md:inline-block normal-case">
					Build with ReactJS and Tailwind CSS
				</h1>
			</div>
